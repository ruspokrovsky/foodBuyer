...
class MultiplePositionsListController extends StateNotifier<List<PositionModel>> {
  MultiplePositionsListController() : super([]);
  ...
  buildPositionList(QuerySnapshot positionsData,List<UserModel> notSubscribersList,) {
  ...
  Future<void> buildMultiplePositionList(List<dynamic> positionsMultiData, List<UserModel> notSubscribersList,) async{
    for (var value in positionsMultiData) {
      buildPositionList(value,notSubscribersList);
    }
  }
